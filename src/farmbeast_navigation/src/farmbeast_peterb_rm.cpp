            ...
            if(!leva_niT && !desna_niT){ //imamo obe strani
                if(absPovpL >= (absPovpD - napaka) && absPovpL <= (absPovpD + napaka)){ //če smo na sredini
                   ...
                   zSmer = xOdmik * -1;
                    ...
                    nova = ((absPovpL - absPovpD)/(absPovpL + absPovpD));
                ...
                if(inv_WL >= 0){
                    nova = ((inv_WL - absPovpD)/(inv_WL + absPovpD));
                    if(nova <= 0.3 && nova >= -0.3){
                         //cout << nova << endl;
                    }else{
                        if(nova  >= 0.3)
                ...
                if(inv_WD >= 0){
                    nova = ((absPovpL - inv_WD)/(inv_WD + absPovpL));
                    if(nova <= 0.3 && nova >= -0.3){
                         //cout << nova << endl;
                    }else{
                        if(nova  >= 0.3)
